        ...
        <div className="login">
            ...
            <div className="login__container">
                ...
                <form>
                    ...
                    type='submit' onClick={signIn} className='login__signInButton'>Sign In</motion.button>
                </form>
                ...
                <motion.button 
                whileHover={{scale:1.05}}
                onClick={register} className='login__registerButton'>Create your Amazon Account</motion.button>
            </div>
        </div>
  )
}
